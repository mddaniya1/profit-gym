...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#F5F5F5] font-sans relative selection:bg-[#C6FF00] selection:text-black">
      {/* Outer frame neon contour line accents matching Dexafit's structural border framing */}
      <div className="fixed inset-0 pointer-events-none z-40 border border-[#C6FF00]/10 rounded-2xl m-1 sm:m-2" />
      ...
      <main className="relative z-10 space-y-4 sm:space-y-6">
        ...
        {/* 5. Packages Section (Dexafit Shop equivalent) */}
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 pointer-events-auto">
        ...
        <button
          ...
          aria-label="Open Pro.Fit AI Coach"
          className="group flex items-center gap-2.5 bg-[#161616] hover:bg-[#1E1E1E] text-white border-2 border-[#C6FF00] px-4 py-2.5 rounded-full shadow-[0_0_20px_rgba(198,255,0,0.35)] hover:scale-105 active:scale-95 transition-all cursor-pointer"
        >
        ...
        <a
          href={getWhatsAppLink('Hi Zulqarnain, I would like to inquire about training with Pro.Fit!')}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Direct WhatsApp chat with Zulqarnain"
          className="w-14 h-14 rounded-full bg-[#C6FF00] text-black flex items-center justify-center shadow-[0_0_25px_rgba(198,255,0,0.5)] hover:scale-110 active:scale-95 transition-all group"
        >
