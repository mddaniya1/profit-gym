        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 sm:mb-16">
          <div>
            ...
            <h2 className="font-display text-4xl sm:text-6xl lg:text-7xl font-black uppercase text-white tracking-tight leading-[0.95]">
              NUTRITION & TRAINING GUIDES FOR MEMBERS
            </h2>
          </div>
          ...
          <div className="shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2.5 bg-[#D4AF37] text-black font-extrabold text-xs tracking-wider uppercase px-6 py-3 rounded-full hover:bg-[#c59e2b] hover:shadow-[0_0_20px_rgba(212,175,55,0.35)] transition-all cursor-pointer group"
            >
          ...
          {ARTICLES.map((article) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#1D1D1D]">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center gap-2 text-[11px] font-extrabold tracking-wider text-[#D4AF37] uppercase">
              ...
              <div className="p-6 sm:p-7 flex flex-col justify-between flex-1">
                <div>
                  <h3 className="font-display text-xl sm:text-2xl font-black uppercase text-white tracking-tight mb-3 group-hover:text-[#D4AF37] transition-colors line-clamp-2">
                    {article.title}
                  </h3>
